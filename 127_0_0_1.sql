...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2025 at 04:43 AM
...
INSERT INTO `product_line` (`item_id`, `item_name`, `item_desc`, `item_description`, `price`) VALUES
(1, 'RTX 5090', 'Electronics', 'Graphics Card', 0);
...
--
-- Table structure for table `tblplay`
--
...
--
-- AUTO_INCREMENT for table `tblplay`
--
ALTER TABLE `tblplay`
...
-- Database: `dbstudent`
--
CREATE DATABASE IF NOT EXISTS `dbstudent` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dbstudent`;
...
INSERT INTO `tblstudent` (`SID`, `FirstName`, `LastName`) VALUES
(1, 'Israel', 'Mollejon'),
(2, 'Reymark', 'Nebrida'),
(3, 'Bhrad', 'Basco'),
(4, 'Mark Jhoozer', 'Ogorda'),
(5, 'Israel', 'Mollejon'),
(6, 'Reymark', 'Nebrida'),
(7, 'Bhrad', 'Basco'),
(8, 'Mark Jhoozer', 'Ogorda'),
(9, 'Israel', 'Mollejon'),
(10, 'Reymark', 'Nebrida'),
(11, 'Bhrad', 'Basco'),
(12, 'Mark Jhoozer', 'Ogorda');
...
--
ALTER TABLE `shop`
  ADD PRIMARY KEY (`article`,`dealer`);
--
-- Database: `employeedb`
--
...
USE `employees`;
--
-- Database: `employeesinfodb`
--
CREATE DATABASE IF NOT EXISTS `employeesinfodb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `employeesinfodb`;
...
-- Database: `group3_db`
--
CREATE DATABASE IF NOT EXISTS `group3_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `group3_db`;
--
-- Database: `jerusalem`
--
CREATE DATABASE IF NOT EXISTS `jerusalem` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `jerusalem`;
...
--
CREATE DATABASE IF NOT EXISTS `librarymanagement_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
('root', '2025-02-05 03:42:43', '{\"Console\\/Mode\":\"collapse\"}');
